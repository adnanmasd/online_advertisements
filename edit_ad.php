...
if (!isset($_GET['id'])) {
    ...
    if (empty($ad) && $ad['user_id'] !== $_SESSION['user']['id']) {
        header("Location: " . "/ad_site/404.php");
    }
}
?>
...
<html>
    <head>
        <?php
        $page_title = " | Edit Your Advertisement";
        ...
        <div class="container">
                ...
                <div class="col-md-12">
                    <div class="page-header">
                        ...
                        <small><p>
                                ...
                                <a href="edit_ad.php?id=<?php echo $_GET['id'] ?>">Edit Ad</a>
                            </p></small>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <form action="controller/save_ad.php" method="POST" enctype="multipart/form-data" class="form-horizontal"  data-parsley-validate="">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group required">
                                    ...
                                    <?php if (isset($ad['image1'])) { ?>
                                        <img src="controller/view_image.php?path=<?php echo $ad['image1'] ?>" class="img-responsive"/>
                                    <?php } else { ?>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group required">
                                    ...
                                    <?php if (isset($ad['image2'])) { ?>
                                        <img src="controller/view_image.php?path=<?php echo $ad['image2'] ?>" class="img-responsive"/>
                                    <?php } else { ?>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group required">
                                    ...
                                    <?php if (isset($ad['image3'])) { ?>
                                        <img src="controller/view_image.php?path=<?php echo $ad['image3'] ?>" class="img-responsive"/>
                                    <?php } else { ?>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group required">
                                    ...
                                    <?php if (isset($ad['image4'])) { ?>
                                        <img src="controller/view_image.php?path=<?php echo $ad['image4'] ?>" class="img-responsive"/>
                                    <?php } else { ?>
