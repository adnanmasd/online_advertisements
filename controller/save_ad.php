...
class Save_Ad {
    ...
    public function __construct() {
        ...
        if (!array_key_exists("error", $result)) {
            ...
            header("Location: " . "/ad_site/edit_ad.php?id=" . $_POST['ad_id']);
        } else {
            $flash->error($result['error'], null, TRUE);
            header("Location: " . "/ad_site/edit_ad.php?id=" . $_POST['ad_id'], true, 307);
        }
    }
    ...
    private function save_ad() {
        ...
        try {
            ...
            $query = "UPDATE ads  SET 
                    ...
                    status = '0' WHERE id = '" . $postData['id'] . "' AND `userId` = '" . $postData['user_id'] . "'";
